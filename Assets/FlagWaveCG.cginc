...
// 
// http://klakos.com/en/advanced-waving-flag-shader-for-unity-double-sided-alpha-shadow-support-3/ ] for
...
void computeWave (inout appdata_full v, inout v2f o)
{
	...
	v.vertex.x+=sin(t*1.45+sinOff)*fx*0.1; 
	v.vertex.y=(sin(t*3.12+sinOff)*fx*0.1-fy*0.9); 
